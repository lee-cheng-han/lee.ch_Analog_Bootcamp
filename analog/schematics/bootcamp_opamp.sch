...
N -130 -0 -90 0 {lab=VIN_N}
N 200 -0 220 0 {lab=VIN_P}
...
N -290 -120 -270 -120 {lab=VDD}
N -290 -170 -290 -120 {lab=VDD}
N -290 -170 -250 -170 {lab=VDD}
C {devices/ipin.sym} 50 -300 1 0 {name=p4 lab=VDD}
C {devices/ipin.sym} 220 0 2 0 {name=p5 lab=VIN_P}
...
device=resistor
m=1}
C {sky130_fd_pr/res_high_po.sym} -250 -120 0 0 {name=R2
model=res_high_po
spiceprefix=X
W=0.35
L=14
mult=1}
C {devices/ipin.sym} -130 0 0 0 {name=p2 lab=VIN_N}
